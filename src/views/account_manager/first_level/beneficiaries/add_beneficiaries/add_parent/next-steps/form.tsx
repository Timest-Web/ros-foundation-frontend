...
export default function AccountManagerAddParentNextStepForm() {
  const {
    handleSubmit,
    control,
    setValue,
        ...
        <div>
          <section className="border border-neutral-300 p-4 lg:w-72 h-[14rem] rounded-md flex flex-col gap-3 text-text-dark">
            ...
            <ControlledInput
              ...
              labelClassName="lg:text-xs pt-[0.15rem]"
            ...
            <Button
              className="bg-white p-2 text-primary-100 border border-neutral-300 font-semibold"
              type="button"
          ...
          <p className="font-plus_jakarta_sans text-xs text-text-dark mt-2">
            ...
            creating user account we would notify them <br></br> about their
            login details
          </p>
        </div>
      </div>
