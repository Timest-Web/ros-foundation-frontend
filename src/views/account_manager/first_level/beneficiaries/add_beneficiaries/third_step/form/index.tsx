...
import { myAccountSchema } from "@/views/beneficiary/account_payout/my_account/form/schema";

type FormValues = z.infer<typeof myAccountSchema>;

export default function AccountManagerAccountForm() {
  const banks = [
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="font-plus_jakarta_sans text-text-dark text-xs mt-2">
          <strong>Hint:</strong> Multiple accounts could be added
        </p>
      </div>
    </Form>
  );
