        ...
        >
          <div className="grid grid-cols-3 gap-x-4 gap-y-6 ">
            ...
            <div className="flex flex-col gap-0.5">
             <div className="flex justify-center items-center"><ScannerIcon /></div> 
              <p className="text-text-dark font-plus_jakarta_sans text-sm text-center">No Data Captured yet</p>
