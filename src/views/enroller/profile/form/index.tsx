...
import { EnrollerProfileUpdateSchema } from "./schema";

type FormValues = z.infer<typeof EnrollerProfileUpdateSchema>;

export default function EnrollerProfileForm() {
  const { control, handleSubmit } = useForm<FormValues>({
    resolver: zodResolver(EnrollerProfileUpdateSchema),
    mode: "onSubmit",
    defaultValues: {
      file: null,
      firstname: "",
        ...
        <div className="grid grid-cols-2 gap-2 w-[40rem]">
          ...
          <div className="flex gap-4 font-plus_jakarta_sans text-text-dark pt-2">
            <section className="flex flex-col gap-2">
              ...
              <p className="text-xs">Enroller</p>
            </section>
            <section className="flex flex-col gap-2">
